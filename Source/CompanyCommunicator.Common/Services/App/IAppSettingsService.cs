...
namespace Microsoft.Teams.Apps.CompanyCommunicator.Common.Services
{
    ...
    public interface IAppSettingsService
    {
        ...
        public Task<string> GetUserAppIdAsync(string tenantId);
        ...
        public Task<string> GetServiceUrlAsync(string tenantId);
        ...
        public Task SetUserAppIdAsync(string userAppId, string tenantId);
        ...
        /// <param name="tenantId">Tenant Id.</param>
        /// <returns>A <see cref="Task"/> representing the asynchronous operation.</returns>
        public Task SetServiceUrlAsync(string serviceUrl, string tenantId);
        ...
        /// <param name="tenantId">Tenant Id.</param>
        /// <returns>A <see cref="Task"/> representing the asynchronous operation.</returns>
        public Task DeleteUserAppIdAsync(string tenantId);
    }
}
