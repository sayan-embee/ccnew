// <copyright file="GroupsServiceByTenant.cs" company="Microsoft">
...
namespace Microsoft.Teams.Apps.CompanyCommunicator.Common.Services.MicrosoftGraph
{
    ...
    /// Groups Service.
    /// </summary>
    internal class GroupsServiceByTenant : IGroupsServiceByTenant
    {
        private readonly IGraphServiceClient graphServiceClient;

        /// <summary>
        /// Initializes a new instance of the <see cref="GroupsServiceByTenant"/> class.
        /// </summary>
        /// <param name="graphServiceClient">graph service client.</param>
        internal GroupsServiceByTenant(IGraphServiceClient graphServiceClient)
        {
