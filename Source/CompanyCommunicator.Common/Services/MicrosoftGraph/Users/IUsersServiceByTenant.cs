// <copyright file="IUsersServiceByTenant.cs" company="Microsoft">
...
namespace Microsoft.Teams.Apps.CompanyCommunicator.Common.Services.MicrosoftGraph
{
    ...
    /// Get the User data.
    /// </summary>
    public interface IUsersServiceByTenant
    {
        /// <summary>
        /// get the list of users by group of userids.
        /// </summary>
        /// <param name="userIdsByGroups">list of grouped user ids.</param>
        /// <param name="type">type e.g ID, EMAIL.</param>
        /// <param name="log">log</param>
        /// <returns>list of users.</returns>
        Task<IEnumerable<User>> GetBatchByUserIds(IEnumerable<IEnumerable<string>> userIdsByGroups, string type = "ID");
