// <copyright file="AppManagerServiceByTenant.cs" company="Microsoft">
...
namespace Microsoft.Teams.Apps.CompanyCommunicator.Common.Services.MicrosoftGraph
{
    ...
    /// </summary>
    internal class AppManagerServiceByTenant : IAppManagerServiceByTenant
    {
        private readonly IGraphServiceClient graphServiceClient;

        /// <summary>
        /// Initializes a new instance of the <see cref="AppManagerServiceByTenant"/> class.
        /// </summary>
        /// <param name="graphServiceClient">V1 Graph service client.</param>
        internal AppManagerServiceByTenant(
