// <copyright file="GroupMembersServiceByTenant.cs" company="Microsoft">
...
namespace Microsoft.Teams.Apps.CompanyCommunicator.Common.Services.MicrosoftGraph
{
    ...
    /// </summary>
    internal class GroupMembersServiceByTenant : IGroupMembersServiceByTenant
    {
        private readonly IGraphServiceClient graphServiceClient;

        /// <summary>
        /// Initializes a new instance of the <see cref="GroupMembersServiceByTenant"/> class.
        /// </summary>
        /// <param name="graphServiceClient">graph service client.</param>
        internal GroupMembersServiceByTenant(IGraphServiceClient graphServiceClient)
        {
