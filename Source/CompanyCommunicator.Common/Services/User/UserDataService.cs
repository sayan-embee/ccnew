...
namespace Microsoft.Teams.Apps.CompanyCommunicator.Common.Services.User
{
    ...
    public class UserDataService : IUserDataService
    {
        ...
        /// <inheritdoc/>
        public async Task SaveUserDataAsync(IConversationUpdateActivity activity, TeamsChannelAccount teamsChannelAccount = null)
        {
            ...
            if (userDataEntity != null)
            {
                ...
                {
                    userDataEntity.Name = teamsChannelAccount.Name;
                    userDataEntity.Email = teamsChannelAccount.Email;
                    userDataEntity.Upn = teamsChannelAccount.UserPrincipalName;
                    userDataEntity.ServiceUrl = activity?.ServiceUrl;
                    userDataEntity.TenantId = activity?.Conversation?.TenantId;
                }
