...
namespace Microsoft.Teams.Apps.CompanyCommunicator.Common.Repositories.NotificationData
{
    ...
    public static class NotificationDataTableNames
    {
        ...
        /// <summary>
        /// Recall notifications partition key name.
        /// </summary>
        public static readonly string RecallSentNotificationsPartition = "RecallSentNotifications";

        /// <summary>
        /// Global sending recall notification data partition key name.
        /// </summary>
        public static readonly string GlobalSendingRecallNotificationDataPartition = "GlobalSendingRecallNotificationData";
    }
}
