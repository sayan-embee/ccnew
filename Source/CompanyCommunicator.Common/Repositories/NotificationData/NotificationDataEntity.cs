...
namespace Microsoft.Teams.Apps.CompanyCommunicator.Common.Repositories.NotificationData
{
    ...
    public class NotificationDataEntity : TableEntity
    {
        ...
        /// <summary>
        /// Gets or sets a value with the JSON describing the templatetype for the adaptive card.
        /// </summary>
        public string TemplateType { get; set; }

        /// <summary>
        /// Gets or sets a value with the JSON describing the tenantid for the adaptive card.
        /// </summary>
        public string TenantId { get; set; }

        /// <summary>
        /// Gets or sets a value with the JSON describing the sendtypeid for the adaptive card.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the total number of read messages.
        /// </summary>
        public int TotalReadReceipt { get; set; }
        ...
        /// <summary>
        /// Gets or sets a value indicating whether gets or sets the IsRecalled value.
        /// </summary>
        public bool IsRecalled { get; set; }

        /// <summary>
        /// Gets or sets the DateTime the notification's recalled was completed.
        /// </summary>
