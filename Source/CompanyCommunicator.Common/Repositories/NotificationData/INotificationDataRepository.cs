...
namespace Microsoft.Teams.Apps.CompanyCommunicator.Common.Repositories.NotificationData
{
    ...
    public interface INotificationDataRepository : IRepository<NotificationDataEntity>
    {
        ...
        /// <summary>
        /// Move a sent notification from sent to recall partition.
        /// </summary>
        /// <param name="sendNotificationEntity">The sent notification instance to be moved to the recall partition.</param>
        /// <returns>The new SentNotification ID.</returns>
        Task<string> MoveSentToRecallPartitionAsync(NotificationDataEntity sendNotificationEntity);

        /// <summary>
        /// UPdate Recall notification status.
        /// </summary>
        /// <param name="notificationId">Notification id.</param>
        /// <param name="status">notification status.</param>
        /// <returns>none.</returns>
        Task UpdateRecallNotificationStatusAsync(string notificationId, NotificationStatus status);

        /// <summary>
        /// SaveRecallExceptionInNotificationDataEntityAsync.
        /// </summary>
        /// <param name="notificationDataEntityId">notificationDataEntityId.</param>
        /// <param name="errorMessage">errorMessage.</param>
        /// <returns>A <see cref="Task"/> representing the result of the asynchronous operation.</returns>
        Task SaveRecallExceptionInNotificationDataEntityAsync(string notificationDataEntityId, string errorMessage);

        /// <summary>
        /// Get all recall sent notification entities from the table storage.
        /// </summary>
        /// <returns>All draft notification entities.</returns>
        public Task<IEnumerable<NotificationDataEntity>> GetAllRecallSentNotificationsAsync();
    }
}
