...
namespace Microsoft.Teams.Apps.CompanyCommunicator.Common.Repositories.NotificationData
{
    ...
    public class GlobalSendingNotificationDataRepository : BaseRepository<GlobalSendingNotificationDataEntity>, IGlobalSendingNotificationDataRepository
    {
        ...
        private static readonly string GlobalSendingRecallNotificationDataRowKey = "GlobalSendingRecallNotificationData";
        ...
        /// <inheritdoc/>
        public async Task<GlobalSendingNotificationDataEntity> GetGlobalSendingRecallNotificationDataEntityAsync()
        {
            return await this.GetAsync(
                NotificationDataTableNames.GlobalSendingRecallNotificationDataPartition,
                GlobalSendingNotificationDataRepository.GlobalSendingRecallNotificationDataRowKey);
        }

        /// <inheritdoc/>
        public async Task SetGlobalSendingRecallNotificationDataEntityAsync(GlobalSendingNotificationDataEntity globalSendingRecallNotificationDataEntity)
        {
            globalSendingRecallNotificationDataEntity.PartitionKey = NotificationDataTableNames.GlobalSendingRecallNotificationDataPartition;
            globalSendingRecallNotificationDataEntity.RowKey = GlobalSendingNotificationDataRepository.GlobalSendingRecallNotificationDataRowKey;

            await this.InsertOrMergeAsync(globalSendingRecallNotificationDataEntity);
        }
    }
}
