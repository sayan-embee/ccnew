// <copyright file="HandleRecallFailureActivity.cs" company="Microsoft">
...
namespace Microsoft.Teams.Apps.CompanyCommunicator.Prep.Func.PreparingToSend
{
    ...
    /// </summary>
    public class HandleRecallFailureActivity
    {
        private readonly INotificationDataRepository notificationDataRepository;
        private readonly IStringLocalizer<Strings> localizer;

        /// <summary>
        /// Initializes a new instance of the <see cref="HandleRecallFailureActivity"/> class.
        /// </summary>
        /// <param name="notificationDataRepository">Notification data repository.</param>
        /// <param name="localizer">Localization service.</param>
        public HandleRecallFailureActivity(
        ...
        [Function(FunctionNames.HandleRecallFailureActivity)]
            ...
            [ActivityTrigger](NotificationDataEntity notification, Exception exception) input)
        {
            ...
            await this.notificationDataRepository
                .SaveRecallExceptionInNotificationDataEntityAsync(input.notification.Id, errorMessage);
        }
    }
}