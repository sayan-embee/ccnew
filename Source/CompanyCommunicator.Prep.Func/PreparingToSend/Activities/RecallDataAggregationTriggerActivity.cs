// <copyright file="RecallDataAggregationTriggerActivity.cs" company="Microsoft">
...
namespace Microsoft.Teams.Apps.CompanyCommunicator.Prep.Func.PreparingToSend
{
    ...
    /// </summary>
    public class RecallDataAggregationTriggerActivity
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RecallDataAggregationTriggerActivity"/> class.
        /// </summary>
        /// <param name="notificationDataRepository">Notification data repository.</param>
        /// <param name="dataRecallQueue">The data queue.</param>
        /// <param name="options">The data queue message options.</param>
        public RecallDataAggregationTriggerActivity(
        ...
        [Function(FunctionNames.RecallDataAggregationTriggerActivity)]
        ...
        {
            var dataQueueMessageContent = new DataRecallQueueMessageContent
            {
