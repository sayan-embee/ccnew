...
namespace Microsoft.Teams.Apps.CompanyCommunicator.Prep.Func.PreparingToSend
{
    ...
    public static class SendQueueOrchestrator
    {
            ...
            [OrchestrationTrigger] TaskOrchestrationContext context)
        {
            ...
            await context.CallActivityAsync(FunctionNames.UpdateNotificationStatusActivity, (notification.Id, NotificationStatus.Sending), FunctionSettings.DefaultRetryOptions);
            ...
            await context.CallActivityAsync(FunctionNames.DataAggregationTriggerActivity, (notification.Id, recipientsList.Count), FunctionSettings.DefaultRetryOptions);
            ...
            for (var batchIndex = 0; batchIndex < totalBatchCount; batchIndex++)
            {
                ...
                var task = context.CallActivityAsync(FunctionNames.SendBatchMessagesActivity, (notification, batches[batchIndex]), FunctionSettings.DefaultRetryOptions);
