...
namespace Microsoft.Teams.Apps.CompanyCommunicator.Prep.Func.PreparingToSend
{
    ...
    public static class FunctionNames
    {
        ...
        /// <summary>
        /// Sync all csv users activity function.
        /// </summary>
        public const string SyncAllCsvUsersActivity = nameof(SyncAllCsvUsersActivity);
        ...
        /// <summary>
        /// Prepare to send recall function.
        /// </summary>
        public const string PrepareToSendRecallFunction = nameof(PrepareToSendRecallFunction);

        /// <summary>
        /// Prepare to send recall orchestrator function.
        /// </summary>
        public const string PrepareToSendRecallOrchestrator = nameof(PrepareToSendRecallOrchestrator);

        /// <summary>
        /// Send recall queue orchestrator function.
        /// </summary>
        public const string SendRecallQueueOrchestrator = nameof(SendRecallQueueOrchestrator);

        /// <summary>
        /// Update recall notification activity function.
        /// </summary>
        public const string UpdateRecallNotificationStatusActivity = nameof(UpdateRecallNotificationStatusActivity);

        /// <summary>
        /// Get recipients recall acitvity function.
        /// </summary>
        public const string GetRecipientsRecallActivity = nameof(GetRecipientsRecallActivity);

        /// <summary>
        /// Get pending recipients recall (ie recipients with no conversation id in the database) acitvity function.
        /// </summary>
        public const string GetPendingRecipientsRecallActivity = nameof(GetPendingRecipientsRecallActivity);

        /// <summary>
        /// Recall Data aggregation activity function.
        /// </summary>
        public const string RecallDataAggregationTriggerActivity = nameof(RecallDataAggregationTriggerActivity);

        /// <summary>
        /// Recall Send batch messages to send queue activity function.
        /// </summary>
        public const string RecallSendBatchMessagesActivity = nameof(RecallSendBatchMessagesActivity);

        /// <summary>
        /// Handle recall failure activity function.
        /// </summary>
        public const string HandleRecallFailureActivity = nameof(HandleRecallFailureActivity);

        /// <summary>
        /// Process and store recall message activity function.
        /// </summary>
        public const string StoreRecallMessageActivity = nameof(StoreRecallMessageActivity);
    }
}
