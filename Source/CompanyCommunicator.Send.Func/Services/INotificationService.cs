...
namespace Microsoft.Teams.Apps.CompanyCommunicator.Send.Func.Services
{
    ...
    public interface INotificationService
    {
        ...
        /// <summary>
        /// Check if pending recall notification.
        /// </summary>
        /// <param name="message">SendRecallQueueMessageContent.</param>
        /// <returns>A <see cref="Task{TResult}"/> representing the result of the asynchronous operation.</returns>
        Task<bool> IsPendingRecallNotification(SendRecallQueueMessageContent message);

        /// <summary>
        /// Check if sent recall notification is throttled or not.
        /// </summary>
        /// <returns>A <see cref="Task{TResult}"/> representing the result of the asynchronous operation.</returns>
        Task<bool> IsSendRecallNotificationThrottled();

        /// <summary>
        /// Update sent recall notification.
        /// </summary>
        /// <param name="notificationId">Notification Id.</param>
        /// <param name="recipientId">Recipient Id.</param>
        /// <param name="totalNumberOfSendThrottles">Total no. of send throttles.</param>
        /// <param name="statusCode">Status code.</param>
        /// <param name="allSendStatusCodes">All send status code.</param>
        /// <param name="errorMessage">Error message.</param>
        /// <param name="activityId">Activity ID.</param>
        /// <returns>A <see cref="Task"/> representing the result of the asynchronous operation.</returns>
        Task UpdateSentRecallNotification(string notificationId, string recipientId, int totalNumberOfSendThrottles, int statusCode, string allSendStatusCodes, string errorMessage, string activityId);
    }
}
