// <copyright file="UpdateRecallNotificationDataEntity.cs" company="Microsoft">
...
namespace Microsoft.Teams.Apps.CompanyCommunicator.Data.Func.Services.NotificationDataServices
{
    ...
    /// </summary>
    public class UpdateRecallNotificationDataEntity : TableEntity
    {
        /// <summary>
        ...
        public bool IsRecalledCompleted()
        {
            return NotificationStatus.Failed.ToString().Equals(this.Status) ||
                NotificationStatus.Recalled.ToString().Equals(this.Status);
        }
    }
}
