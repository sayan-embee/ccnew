...
namespace Microsoft.Teams.Apps.CompanyCommunicator.Authentication
{
    ...
    public static class AuthenticationServiceCollectionExtensions
    {
            ...
            AuthenticationOptions authenticationOptions)
        {
            ...
            // Microsoft.Identity.Web 2.x API: AddMicrosoftIdentityWebApi replaces the legacy
            // AddProtectedWebApi/AddProtectedWebApiCallsProtectedWebApi pair from preview 0.1.x.
