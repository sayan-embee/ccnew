            ...
            content: (
                <Flex vAlign="center" fill gap="gap.small">
                    ...
                    <Flex.Item size="size.quarter" variables={{ 'size.quarter': '10%' }} shrink={false}>
                        <Text
                            truncated
                            content={this.localize("ReadReceipt")}
                            weight="bold"
                        >
                        </Text>
                    </Flex.Item>
    ...
    private messageContent = (message: any) => {
        ...
        return (
            <Flex className="listContainer" vAlign="center" fill gap="gap.small">
                ...
                <Flex.Item size="size.quarter" variables={{ 'size.quarter': '10%' }} >
                    <Text
                        truncated
                        className="semiBold"
                        content={message.totalReadReceipt}
                    />
                </Flex.Item>
                <Flex.Item size="size.quarter" variables={{ 'size.quarter': '15%' }} >
                    <Text
...
export default connect(mapStateToProps, { selectMessage, getMessagesList, getDraftMessagesList, getRecalledMessagesList})(messagesWithTranslation);