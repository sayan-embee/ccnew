...
import { selectMessage, getRecalledMessagesList} from '../../actions';
                    ...
                    items: [
                        {
                            ...
                            onClick: (event: any) => {
                                ...
                                let url = getBaseUrl() + "/viewstatus/" + this.props.message.id + "?locale={locale}&openfrom=recall";
...
export default connect(mapStateToProps, { selectMessage, getRecalledMessagesList })(overflowWithTranslation);
