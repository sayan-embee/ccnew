...
import { selectMessage, getScheduledMessagesList, getDraftMessagesList, getMessagesList, getRecalledMessagesList } from '../../actions';
            ...
            const out = {
                ...
                content: (
                    <Flex vAlign="center" fill gap="gap.small">
                        ...
                        <Flex.Item size="size.quarter" align="end" styles={{ justifyContent:"end"}}>
        ...
        const out = [{
            ...
            content: (
                <Flex vAlign="center" fill gap="gap.small">
                    ...
                    <Flex.Item push size="size.quarter">
                        <Text
                            truncated
...
export default connect(mapStateToProps, { selectMessage, getScheduledMessagesList, getDraftMessagesList, getMessagesList, getRecalledMessagesList })(ScheduledMessagesWithTranslation);