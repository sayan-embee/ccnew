...
import { selectMessage, getDraftMessagesList, getScheduledMessagesList, getMessagesList,getRecalledMessagesList } from '../../actions';
...
export default connect(mapStateToProps, { selectMessage, getDraftMessagesList, getScheduledMessagesList, getRecalledMessagesList })(draftMessagesWithTranslation);