...
import RecalledMessages from '../RecalledMessages/recalledMessages';
...
class TabContainer extends React.Component<ITaskInfoProps, ITabContainerState> {
    ...
    constructor(props: ITaskInfoProps) {
        ...
        this.state = {
            url: getBaseUrl() + "/customNewmessage?locale={locale}"
        }
    ...
    public render(): JSX.Element {
        const panels = [
            ...
            {
                title: this.localize('RecallSentMessagesSectionTitle'),
                content: {
                    key: 'recalled',
                    content: (
