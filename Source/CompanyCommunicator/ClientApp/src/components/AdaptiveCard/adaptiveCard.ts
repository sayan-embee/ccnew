...
export const getCardTeamsName = (card: any) => {
    return card.body[0].text;
}

export const setCardTeamsName = (card: any, teamsName: string) => {
