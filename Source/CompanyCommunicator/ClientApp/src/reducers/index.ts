...
export const recalledmessagesListReducer = (recalledMessages = [], action: { type: string; payload: any; }) => {
    if (action.type === 'FETCH_RECALLEDMESSAGES') {
        return action.payload
    }
...
export default combineReducers({
    ...
    recalledMessagesList:recalledmessagesListReducer
});