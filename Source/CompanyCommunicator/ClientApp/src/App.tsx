...
import InitialPageNewMessage from './components/NewMessage/initialPage';
...
import RecalledConfirmationTaskModule from './components/RecalledConfirmationTaskModule/recalledConfirmationTaskModule';
                    ...
                    <div className="appContainer">
                        <BrowserRouter>
                            <Switch>
                                ...
                                <Route exact path="/customNewmessage" component={InitialPageNewMessage} />
                                ...
                                <Route exact path="/recallconfirmation/:id" component={RecalledConfirmationTaskModule} />
                            </Switch>
                        </BrowserRouter>
                    </div>
                </Suspense>
