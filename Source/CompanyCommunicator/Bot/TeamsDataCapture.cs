...
namespace Microsoft.Teams.Apps.CompanyCommunicator.Bot
{
    ...
    public class TeamsDataCapture
    {
        ...
        public async Task OnBotAddedAsync(IConversationUpdateActivity activity, TeamsChannelAccount teamsChannelAccount = null)
        {
            ...
            switch (activity.Conversation.ConversationType)
            {
                ...
                case TeamsDataCapture.PersonalType:
                    await this.userDataService.SaveUserDataAsync(activity, teamsChannelAccount);
                    break;
                default: break;
            }

            // Update service url app setting.
            await this.UpdateServiceUrl(activity.ServiceUrl, activity.Conversation.TenantId);
        }
        ...
        private async Task UpdateServiceUrl(string serviceUrl, string tenantId)
        {
            // Check if service url is already synced.
            var cachedUrl = await this.appSettingsService.GetServiceUrlAsync(tenantId);
            ...
            // Update service url.
            await this.appSettingsService.SetServiceUrlAsync(serviceUrl, tenantId);
        }
    }
}
