...
namespace Microsoft.Teams.Apps.CompanyCommunicator.Controllers
{
    ...
    public class DraftNotificationsController : ControllerBase
    {
        ...
        public async Task<ActionResult<string>> CreateDraftNotificationAsync([FromBody] DraftNotification notification)
        {
            ...
            var groupServiceByTenant = this.graphServiceFactoryByTenant.GetGroupsService(notification.TenantId);
            var containsHiddenMembership = await groupServiceByTenant.ContainsHiddenMembershipAsync(notification.Groups);
        ...
        public async Task<ActionResult<DraftNotificationSummaryForConsent>> GetDraftNotificationSummaryForConsentByIdAsync(string notificationId)
        {
            ...
            var groupsServiceByTenant = this.graphServiceFactoryByTenant.GetGroupsService(notificationEntity.TenantId);

            var groupNames = await groupsServiceByTenant
            ...
            [FromBody] DraftNotificationPreviewRequest draftNotificationPreviewRequest)
        {
            ...
            teamDataEntity.ServiceUrl = await this.appSettingsService.GetServiceUrlAsync(notificationEntity.TenantId);
