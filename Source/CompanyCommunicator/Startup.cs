        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddOptions<UserAppOptions>()
                ...
                options.UserAppExternalId =
                    configuration.GetValue<string>("UserAppExternalId", "136d728d-711c-41f2-ba7f-88c0f977bb03"); // "148a66bb-e83d-425a-927d-09f4299a9274");
                });
            ...
            services.AddSingleton<ITenantDataRepository, TenantDataRepository>();
            ...
            // Add service bus message queues.
            services.AddSingleton<IPrepareToRecallQueue, PrepareToRecallQueue>();
            ...
            // Adding Helper services
            services.AddSingleton<CloudStorageHelper, CloudStorageHelper>();
            services.AddSingleton<IPrivateBlobAndContainerHelper, PrivateBlobAndContainerHelper>();

            // Add Service Factory Other Tenant
